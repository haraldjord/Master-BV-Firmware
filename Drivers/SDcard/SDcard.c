...
void writeMissionLog(){
  ...
  n += sprintf(&buffer[n],"%f,",missionLog.pidDataOut.PID_output);
  n += sprintf(&buffer[n],"%f,",missionLog.pidDataOut.kp);
  n += sprintf(&buffer[n],"%f,",missionLog.pidDataOut.ki);
  n += sprintf(&buffer[n],"%f,",missionLog.pidDataOut.kd);
  n += sprintf(&buffer[n],"%f,",missionLog.pressureVoltage);
  n += sprintf(&buffer[n],"%f,",missionLog.pressurePsi);
  n += sprintf(&buffer[n],"%f,",missionLog.unfilteredDepth);
  n += sprintf(&buffer[n],"%f,",missionLog.filteredDepth);
